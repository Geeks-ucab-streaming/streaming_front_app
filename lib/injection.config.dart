...
import 'infrastructure/core/repositories/advertisement_repository_impl.dart'
    as _i3;
import 'infrastructure/core/services/firebase_api.dart' as _i7;
import 'infrastructure/core/util/dio_instance.dart' as _i12;
import 'infrastructure/core/util/logger_instance.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.FireBaseAPI>(() => _i7.FireBaseAPI());
    gh.lazySingleton<_i8.LoggerInstance>(() => _i8.LoggerInstance());
    gh.lazySingleton<_i9.PlaylistRepositoryImpl>(
        () => _i9.PlaylistRepositoryImpl());
    gh.lazySingleton<_i10.SongRepositoryImpl>(() => _i10.SongRepositoryImpl());
    gh.factory<String>(
      () => dioInstance.baseUrl,
...
class _$DioInstance extends _i12.DioInstance {}
