...
/// @nodoc
@JsonSerializable()
class _$SubscriptionDtoImpl
    with DiagnosticableTreeMixin
    implements _SubscriptionDto {
  const _$SubscriptionDtoImpl({required this.id, required this.state});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SubscriptionDto(id: $id, state: $state)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'SubscriptionDto'))
...
abstract class _SubscriptionDto implements SubscriptionDto {
  const factory _SubscriptionDto(
      ...
      required final String state}) = _$SubscriptionDtoImpl;
